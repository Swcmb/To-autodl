...
# 参数空间默认值（满足题述要求）
DEFAULT_FEATURE_TYPES = ["normal"]  # one_hot|uniform|normal|position
DEFAULT_AUGMENTS = ["random_permute_features"]  # none|random_permute_features|add_noise|attribute_mask|noise_then_mask
DEFAULT_AUGMENT_MODES = ["static"]  # static|online
DEFAULT_ENCODER_TYPES = ["csglmd"]  # csglmd|csglmd_main|mgacmda|gat|gt|gat_gt_serial|gat_gt_parallel
DEFAULT_FUSION_TYPES = ["basic"]  # basic|dot|additive|self_attn|gat_fusion|gt_fusion
DEFAULT_QUEUE_WARMUPS = [0]  # int
